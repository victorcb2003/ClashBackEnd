...
module.exports = class Equipe {
    ...
    static info(req, res) {
        ...
        const sql = `
        Select User.id,User.email,User.prenom,User.nom,Joueurs.id as Joueurs_id from User inner join Joueurs on Joueurs.User_id = User.id where Joueurs.Equipe_id = ?;
