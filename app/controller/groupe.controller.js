...
exports.add = (req, res) => {
    ...
    if (!req.body.groupe_id) {
        return res.status(400).send({ error : "req.body.groupe_id est requis." })
    }
...
exports.messageCreate = (req, res) => {
    ...
    if (!req.body.message) {
        res.status(400).send({ error : "req.body.message est requis." })
    }
...
exports.messageUpdate = (req, res) => {
    ...
    if (!req.body.message_id) {
        res.status(400).send({ error : "req.body.message_id est requis." })
    }
    if (!req.body.message) {
        res.status(400).send({ error : "req.body.message est requis." })
    }
