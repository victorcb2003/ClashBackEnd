...
exports.create = (req, res) => {
    ...
    if (!req.body.date) {
        return res.status(400).send({ message: "req.body.date est requis." })
    }
...
exports.update = (req, res) => {
    ...
    if (!req.body.nom && !req.body.date && !req.body.lieu) {
        return res.status(400).send({ message: "Il faut au moins remplir req.body.nom ou req.body.date ou req.body.lieu" })
    }
